	...
	<div class="wpf-settings">
		<div class="shortpixel-settings-wrap">
			...
			<div class="support-and-preferences">
				<a href="https://shortpixel.com/knowledge-base/category/307-shortpixel-adaptive-images" target="_blank"><?= __( 'Help', 'shortpixel-adaptive-images' ); ?></a>
			...
			<div class="shortpixel-settings-tabs">
				<h2 class="nav-tab-wrapper" id="wpspai-tabs">
                    ...
                    <?php if( $options->settings_areas_parseCssFiles ): ?>
